package com.eximbills.backservice1;

import com.eximbills.backservice1.domain.Balance;
import com.eximbills.backservice1.domain.Entry;
import com.eximbills.backservice1.repository.BalanceRepository;
import com.eximbills.backservice1.repository.EntryRepository;
...
public class Backservice1Application {

    private static final Logger logger = LoggerFactory.getLogger(Backservice1Application.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(Backservice1Application.class, args);
    }
    ...
    String home() {
        ...
        return "Servie 1 listening on port 8081...";
    }
